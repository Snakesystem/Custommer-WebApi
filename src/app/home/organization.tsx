              ...
              <div className="row">
                ...
                <div className="col-4 text-end">
                  <div className="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle">
                    <i className="bi bi-currency-dollar text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-4 text-end">
                  <div className="icon icon-shape bg-gradient-danger shadow-danger text-center rounded-circle">
                    <i className="bi bi-person text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-4 text-end">
                  <div className="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                    <i className="bi bi-people text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-4 text-end">
                  <div className="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                    <i className="bi bi-cart text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
